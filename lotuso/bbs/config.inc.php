...
// [CH] 论坛安全设置, 调整以下设置，可以增强论坛的安全性能和防御性能
	...
	$adminemail = 'bienfantaisie@163.com';		// 系统管理员 Email
...
define('UC_DBHOST', 'www.lotuso.com');
define('UC_DBUSER', 'root');
define('UC_DBPW', '123456');
define('UC_DBNAME', 'acgucq7');
define('UC_DBCHARSET', 'gbk');
define('UC_DBTABLEPRE', '`acgucq7`.uc_');
define('UC_DBCONNECT', '0');
define('UC_KEY', 'ocg28ar916udYa0aDa04V7Pb59e75d71TdZ2G2X8D3JaY4V9FeMdB2F0t8S7p5m4');
define('UC_API', 'http://www.lotuso.com/ucenter');
