...
//Ucenter Home配置参数
$_SC = array();
$_SC['dbhost']  		= 'www.lotuso.com'; //服务器地址
$_SC['dbuser']  		= 'root'; //用户
$_SC['dbpw'] 	 		= '123456'; //密码
$_SC['dbcharset'] 		= 'gbk'; //字符集
$_SC['pconnect'] 		= 0; //是否持续连接
$_SC['dbname']  		= 'acgucq7'; //数据库
...
define('UC_DBHOST', 'www.lotuso.com'); // UCenter 数据库主机
define('UC_DBUSER', 'root'); // UCenter 数据库用户名
define('UC_DBPW', '123456'); // UCenter 数据库密码
define('UC_DBNAME', 'acgucq7'); // UCenter 数据库名称
define('UC_DBCHARSET', 'gbk'); // UCenter 数据库字符集
define('UC_DBTABLEPRE', '`acgucq7`.uc_'); // UCenter 数据库表前缀
define('UC_DBCONNECT', '0'); // UCenter 数据库持久连接 0=关闭, 1=打开
define('UC_KEY', 'r0P8sb79E4U7i86ey6ed01m3mf28ifO22bb4N8ydzaTehaS6ScncedPb8582Cdxa'); // 与 UCenter 的通信密钥, 要与 UCenter 保持一致
define('UC_API', 'http://www.lotuso.com/ucenter'); // UCenter 的 URL 地址, 在调用头像时依赖此常量
