...
Dim TotalNum,Assay,MaxWidth,Rows,SYear,SMonth

MaxWidth=270
TotalNum=0
QMonth=Request.QueryString("QMonth")
If QMonth="" Then QMonth=Cstr(Year(Date)&"-"&Month(Date))
...
<div align="center">
  ...
  <table width="720" border="0" cellpadding="3" cellspacing="1" bgcolor="#6298E1">
    <tr>
      <td height="24" colspan="4"><font color="#FFFFFF"><strong><%=QMonth%>月访统计分析&nbsp;</strong>(&nbsp;总量：<%=TotalNum%>&nbsp;)&nbsp;&nbsp;&nbsp;&nbsp;<a href="StatAllMonth.asp" ><font color="#FFFFFF">[&nbsp;全部月分析&nbsp;]</font></a></font></td>
    </tr>
    <tr bgcolor="#D7E4F7">
      <td width="25%">日期</td>
      <td width="20%">访问人数</td>
