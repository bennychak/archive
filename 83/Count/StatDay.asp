...
MaxWidth=270
TotalNum=0
QDay=Request.QueryString("QDay")
If QDay="" Then QDay=Cstr(Year(Date)&"-"&Month(Date)&"-"&Day(date))
Rows=23
...
<div align="center">
  ...
  <table width="720" border="0" cellpadding="3" cellspacing="1" bgcolor="#6298E1">
    <tr>
      <td height="24" colspan="4"><font color="#FFFFFF"><strong><%=QDay%>日访统计分析&nbsp;</strong>(&nbsp;总量：<%=TotalNum%>&nbsp;)&nbsp;&nbsp;&nbsp;&nbsp;<a href="StatAllDay.asp" ><font color="#FFFFFF">[&nbsp;全部日分析&nbsp;]</font></a></font></td>
    </tr>
    <tr bgcolor="#D7E4F7">
      <td width="25%">小时</td>
      <td width="20%">访问人数</td>
    ...
    <tr bgcolor="#EBF2F9" onMouseOver = 'this.style.backgroundColor = "#FFFFFF"' onMouseOut = 'this.style.backgroundColor = ""' style="cursor:hand">
      <td><%=mid(i+100,2)&":00-"&mid(i+101,2)&":00"%></td>
      <td><%=Assay(i,0)%></td>
      <td><%=Percent(i)%></td>
