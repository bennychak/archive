...
MaxWidth=270
TotalNum=0
Sql="Select * From FIpone Order By TOneNum DESC"
...
<div align="center">
    ...
    <table width="720" border="0" cellpadding="3" cellspacing="1" bgcolor="#6298E1">
      <tr>
        <td height="24" colspan="4"><font color="#FFFFFF"><strong>访问者IP首段地址分析&nbsp;</strong>(&nbsp;总量：<%=TotalNum%>&nbsp;)&nbsp;&nbsp;&nbsp;&nbsp;<a href="FIptwo.asp"><font color="#FFFFFF">[&nbsp;IP地址分析&nbsp;]</font></a></font></td>
      </tr>
      <tr bgcolor="#D7E4F7">
        <td width="25%">IP首段</td>
        <td width="20%">访问人数</td>
