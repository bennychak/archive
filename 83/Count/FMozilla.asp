...
<div align="center">
  ...
  <table width="720" border="0" cellpadding="3" cellspacing="1" bgcolor="#6298E1">
    <tr>
      <td height="24" colspan="4"><font color="#FFFFFF"><strong>访问者&nbsp;HTTP_USER_AGENT 字符串分析&nbsp;</strong>(&nbsp;总量：<%=TotalNum%>&nbsp;)&nbsp;&nbsp;&nbsp;&nbsp;<a href="FBrowser.asp"> <font color="#FFFFFF">[&nbsp;浏览器分析&nbsp;]</font></a></font></td>
    </tr>
    <tr bgcolor="#D7E4F7">
      <td width="40%">USER_AGENT</td>
      <td width="10%">访问人数</td>
      <td width="10%">百分比</td>
      <td width="40%">图示</td>
    </tr>
