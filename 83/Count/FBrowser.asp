...
<div align="center">
    ...
    <table width="720" border="0" cellpadding="3" cellspacing="1" bgcolor="#6298E1">
      <tr>
        <td height="24" colspan="4"><font color="#FFFFFF"><strong>访问者所用浏览器分析&nbsp;</strong>(&nbsp;总量：<%=TotalNum%>&nbsp;)&nbsp;&nbsp;&nbsp;&nbsp;<a href="FMozilla.asp"> <font color="#FFFFFF">[&nbsp;HTTP_USER_AGENT字符串分析&nbsp;]</font></a></font></td>
      </tr>
      <tr bgcolor="#D7E4F7">
        <td width="25%">浏览器</td>
        <td width="20%">访问人数</td>
