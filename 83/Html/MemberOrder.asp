...
function WebLocation()
  WebLocation="<img src=""../Images/Arrow_02.gif"" />&nbsp;您的位置：<a href=""../index.asp"" title=""返回首页"">首页</a>" & _
              ...
              "<img src=""../Images/Arrow_03.gif"" />我的订单"
end function
...
function WebContent()
  ...
  if(idcount>0 and sqlid<>"") then'如果记录总数=0,则不处理
    ...
    while not rs.eof '填充数据到表格
      ...
      response.write rs("OrderName")&"&nbsp;<span class=""Black-bbb"">SEND:"&FormatDate(rs("Addtime"),13)&"</span>"
	  ...
	  response.write HtmlStrReplace(rs("Remark"))&"<br /><br />"
	  response.write "联系　人："&rs("Linkman")&"<br />"
	  response.write "性　　别："&rs("Sex")&"<br />"
	  response.write "单　　位："&rs("Company")&"<br />"
	  response.write "地　　址："&rs("Address")&"<br />"
	  response.write "邮　　编："&rs("ZipCode")&"<br />"
	  response.write "电　　话："&rs("Telephone")&"<br />"
	  response.write "传　　真："&rs("Fax")&"<br />"	  
	  response.write "移动电话："&rs("Mobile")&"<br />"	  
	  response.write "电子邮件："&rs("Email")&"<br />"	  
