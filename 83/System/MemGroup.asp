...
'-----------------------------------------------------------
  if(idcount>0 and sqlid<>"") then'如果记录总数=0,则不处理
    ...
    while(not rs.eof)'填充数据到表格
      ...
      Response.Write "<td nowrap><font color='blue'>"&rs("GroupLevel")&"</font></td>" & vbCrLf
      ...
      Response.Write "<td width='40' nowrap><a href='MemGroup.asp?Result=Modify&ID="&rs("ID")&"' onClick='changeAdminFlag(""修改会员组别"")'><font color='#330099'>修改</font></a></td>" & vbCrLf
    ...
    Response.Write "<td nowrap colspan='2'  bgcolor='#EBF2F9'><input name='submitDelSelect' type='button' class='button'  id='submitDelSelect' value='删除所选'  onClick='ConfirmDel(""您真的要删除这些会员组别吗？"");'></td>" & vbCrLf
    Response.Write "</tr>" & vbCrLf
  else
