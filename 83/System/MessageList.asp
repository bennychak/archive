...
<table width="100%" border="0" cellpadding="3" cellspacing="1" bgcolor="#6298E1">
  ...
  <tr>
    ...
    <td width="88" bgcolor="#8DB5E9"><font color="#FFFFFF"><strong>留言者</strong></font></td>
    <td nowrap bgcolor="#8DB5E9"><font color="#FFFFFF"><strong>留言标题</strong></font></td>
    <td width="28" nowrap bgcolor="#8DB5E9"><strong><font color="#FFFFFF"><strong>标记</strong></font></strong></td>
    <td width="118" nowrap bgcolor="#8DB5E9"><strong><font color="#FFFFFF">留言时间</font></strong></td>
  ...
  if(idcount>0 and sqlid<>"") then'如果记录总数=0,则不处理
    ...
    while(not rs.eof)'填充数据到表格
      ...
      if rs("SecretFlag") then
        Response.Write "<td nowrap><font color='red'>悄</font></td>" & vbCrLf
      else
