  ...
  <tr>
    <td height="36" align="center" nowrap  bgcolor="#EBF2F9"><table width="100%" border="0" cellspacing="0">
      <tr>
        ...
        <td align="right" nowrap>查看：<a href="OrderList.asp" onClick='changeAdminFlag("订单信息列表")'>所有订单信息</a></td>
      </tr>
    </table>
	</td>    
  </tr>
...
<table width="100%" border="0" cellpadding="3" cellspacing="1" bgcolor="#6298E1">
  ...
  <tr>
    ...
    <td width="88" bgcolor="#8DB5E9"><font color="#FFFFFF"><strong>订购者</strong></font></td>
    <td nowrap bgcolor="#8DB5E9"><font color="#FFFFFF"><strong>订购单标题</strong></font></td>
    <td width="126" nowrap bgcolor="#8DB5E9"><strong><font color="#FFFFFF">订购单位</font></strong></td>
    <td width="118" nowrap bgcolor="#8DB5E9"><strong><font color="#FFFFFF">订购时间</font></strong></td>
  ...
  if(idcount>0 and sqlid<>"") then'如果记录总数=0,则不处理
    ...
    while(not rs.eof)'填充数据到表格
	  ...
	  if StrLen(rs("OrderName"))>45 then
        Response.Write "<td title="&rs("OrderName")&" nowrap>"&StrLeft(rs("OrderName"),42)&"</td>" & vbCrLf
      else
        Response.Write "<td title="&rs("OrderName")&" nowrap>"&rs("OrderName")&"</td>" & vbCrLf
      end if 
	  if StrLen(rs("Company"))>21 then
        Response.Write "<td title="&rs("Company")&" nowrap>"&StrLeft(rs("Company"),18)&"</td>" & vbCrLf
      else
      ...
      Response.Write "<td width='48' nowrap><a href='OrderEdit.asp?Result=Modify&ID="&rs("ID")&"' onClick='changeAdminFlag(""查看回复订单信息"")'><font color='#330099'>查看.回</font></a></td>" & vbCrLf
    ...
    Response.Write "<td colspan='2' nowrap  bgcolor='#EBF2F9'><input name='submitDelSelect' type='button' class='button'  id='submitDelSelect' value='删除所选' onClick='ConfirmDel(""您真的要删除这些订单信息吗？"");'></td>" & vbCrLf
    Response.Write "</tr>" & vbCrLf
  else
    response.write "<tr><td height='50' align='center' colspan='8' nowrap  bgcolor='#EBF2F9'>暂无订单信息</td></tr>"
  end if
'-----------------------------------------------------------
'-----------------------------------------------------------
  Response.Write "<tr>" & vbCrLf
