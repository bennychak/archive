...
'-----------------------------------------------------------
  if(idcount>0 and sqlid<>"") then'如果记录总数=0,则不处理
    ...
    while(not rs.eof)'填充数据到表格
      ...
      Response.Write "<td width='48' nowrap><a href='AdminEdit.asp?Result=Modify&ID="&rs("ID")&"' onClick='changeAdminFlag(""修改管理员"")'><font color='#330099'>修改</font></a></td>" & vbCrLf
      if rs("ID")=1 then
	    Response.Write "<td width='14' nowrap></td>" & vbCrLf
      else
