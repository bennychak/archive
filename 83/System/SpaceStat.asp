...
<table width="100%" border="0" cellpadding="3" cellspacing="1" bgcolor="#6298E1">
  ...
  <tr bgcolor="#EBF2F9" onMouseOver = 'this.style.backgroundColor = "#FFFFFF"' onMouseOut = 'this.style.backgroundColor = ""' style="cursor:hand">
    <td height="20" >模板文件</td>
    <td ><%=SysRootDir&"Skin"%></td>
    <td ><%=SizeInfo(SizeByte(SysRootDir&"Skin"))%></td>
    <td ><%=FormatPercent(Percent(SizeByte(SysRootDir&"Skin")),,-1)%></td>
    <td ><img src="images/bar.gif" width="<%=Percent(SizeByte(SysRootDir&"Skin"))*260%>" height="8"></td>
  </tr>
</table>
</body>
</html>
