...
if (isset($_POST['systeminfo'])) {
        if (isset($_POST['submit'])) {
            ...
            $GLOBALS['celsysteminfo']->conf(addslashes($_POST['url']), addslashes($_POST['template']), addslashes($_POST['company']), addslashes($_POST['language']), $customer_info, addslashes($_POST['tracker_refresh']));
        }
...
for($i=0;$i<count($result);$i++)
{
	...
	<tr class=\"light\">
      ...
      <td align=\"left\"><img src=\"".$config['url']."/templates/".$config['template']."/images/del.gif\" width=\"16\" height=\"16\" /><a href=\"system.php?action=departments&do=delete&departmentid=".$departmentid."\" onClick=\"return confirm('确认删除?');\">删除</a></td>
    </tr>  
";
}
