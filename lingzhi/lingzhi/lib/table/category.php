...
class category extends table {
    ...
    function get_form() {
        return array(
            ...
            'htmlrule'=>array(
                'tips'=>' <a href="javascript:void(0)" title="默认：{$caturl}/{$page}.html ，可把{$caturl}替换成{$dir}或者自定义合法字符，{$page}不可去掉，其中{$caturl}代表栏目目录（含上级目录），{$dir}代表当前栏目目录（不含上级目录）" onclick="tips1.style.display = \'block\';"><font color="red">?</font></a><div id="tips1" style="display:none;color:green">默认：{$caturl}/{$page}.html ，可把{$caturl}替换成{$dir}或者自定义合法字符，{$page}不可去掉，其中{$caturl}代表栏目目录（含上级目录），{$dir}代表当前栏目目录（不含上级目录）</div>',
            ),
            'listhtmlrule'=>array(
                'tips'=>' <a href="javascript:void(0)" title="默认：{$caturl}/{$page}.html ，可把{$caturl}替换成{$dir}或者自定义合法字符，{$page}不可去掉，其中{$caturl}代表栏目目录（含上级目录），{$dir}代表当前栏目目录（不含上级目录）" onclick="tips2.style.display = \'block\';"><font color="red">?</font></a><div id="tips2" style="display:none;color:green">默认：{$caturl}/{$page}.html ，可把{$caturl}替换成{$dir}或者自定义合法字符，{$page}不可去掉，其中{$caturl}代表栏目目录（含上级目录），{$dir}代表当前栏目目录（不含上级目录）</div>',
            ),
            'showhtmlrule'=>array(
                'tips'=>' <a href="javascript:void(0)" title="默认：{$caturl}/show_{$aid}(_{$page}).html ，可把{$caturl}替换成{$dir}或者自定义合法字符，{$aid}和{$page}不可去掉，其中{$caturl}代表栏目目录（含上级目录），{$dir}代表当前栏目目录（不含上级目录）" onclick="tips3.style.display = \'block\';"><font color="red">?</font></a><div id="tips3" style="display:none;color:green">默认：{$caturl}/show_{$aid}(_{$page}).html ，可把{$caturl}替换成{$dir}或者自定义合法字符，{$aid}和{$page}不可去掉，其中{$caturl}代表栏目目录（含上级目录），{$dir}代表当前栏目目录（不含上级目录）</div>',
            ),
            'image'=>array(
                'filetype'=>'image',
            ),
