...
<script src="{$base_url}/common/js/common.js"></script>
...
<div id="position">
    <a href="javascript:history.back(-1)" title="返回上一页"><img alt="返回上一页" src="{$skin_path}/undo.gif" style="float:right;" /></a>当前位置：编辑模板
</div>

<div class="padding10">
    <img src="{$skin_path}/wj.gif" style="margin-right:10px;" />欢迎来到在线编辑模板页面。您可以在网站后台即可完成网站样式的修改。
</div>
