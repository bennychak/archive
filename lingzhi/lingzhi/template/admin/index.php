...
<script type="text/javascript" src="{$skin_path}/system.js"></script>
...
background-color:#F8F8F8;
     ...
     <script type="text/javascript">
		...
		<style>
#logo {background:url({$skin_path}/logo.png) no-repeat 10px 8px !important; 
/*For Firefox*/
*background:none;
/*For IE7 & IE6*/
_filter:progid:DXImageTransform.Microsoft.AlphaImageLoader(src='{$skin_path}/logo.png',sizingMethod='crop');}
		</style>
<!--[if IE 6]>
<style type="text/css">
/*ie6 fix顶端元素*/
...
<div id="top_left">
<div id="top_right">
<div id="logo"><a href="{$base_url}/index.php?case=index&act=index&=&admin_dir=admin" title="后台首页"><span>后台首页</span></a></div>
<div class="top">
<span class="floatright"><a href="{$base_url}/" target="_blank">网站首页</a>	| <a href="http://www.cmseasy.org" target="_blank">论坛</a>	| <a href="http://www.cmseasy.org/forum-10-1.html" target="_blank">报错</a> | <a href="http://www.cmseasy.org/forum-9-1.html" target="_blank">在线教程</a></span>	
<span class="floatleft">欢迎您，{$user.username}</span>	 <a href="{$base_url}/index.php?case=index&act=logout&admin_dir={config::get('admin_dir')}" class="logout">退出</a>
<div id="nav">
<ul>
...
?>
<li><a href="{$m}" class="{$class}">{$n}</a></li>
{/loop}
...
<div class="blank30"></div>
	<a href="#"><img src="{$skin_path}/gotop.gif" style="float:right;padding-right:30px;" /></a>
</div>
</div>
</div>
</div>
