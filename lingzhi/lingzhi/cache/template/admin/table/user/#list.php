...
<div id="position">
<a href="javascript:history.back(-1)" title="返回上一页"><img alt="返回上一页" src="<?php echo $skin_path;?>/undo.gif" style="float:right;" /></a>当前位置：用户列表
</div>
<div class="padding10">
<img src="<?php echo $skin_path;?>/wj.gif" style="margin-right:10px;" />欢迎来到用户列表页面。您可以编辑可登录网站的用户，使得网站与浏览者可以完成良好的互动形式。
</div>
...
<td><?php echo cut($d['userid']);?></td>
<td><?php echo cut($d['username']);?></td>
<td><?php echo cut($d['nickname']);?></td>
<td><?php echo usergroupname($d['groupid']);?></td>
