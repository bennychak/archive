...
<div id="position">
    <a href="javascript:history.back(-1)" title="返回上一页"><img alt="返回上一页" src="<?php echo $skin_path;?>/undo.gif" style="float:right;" /></a>当前位置：栏目列表
</div>

<div class="padding10">
    <img src="<?php echo $skin_path;?>/wj.gif" style="margin-right:10px;" />欢迎来到栏目列表页面。您可以编辑添加内容栏目，将网站内容加以栏目整理。
</div>
...
<form name="listform" id="listform"  action="<?php echo uri();?>" method="post">
    ...
    <a href="index.php?case=table&act=add&table=category&admin_dir=<?php echo get('admin_dir');?>" class="button">添加栏目</a>
</td></tr></table>
    <div class="blank10"></div>
        ...
        <tbody id="listtable">
            ...
            <tr class="s_out" onmouseover="m_over(this)" onmouseout="m_out(this)" lang="<?php echo $d['level'];?>" <?php if($d['level']>0) { ?>style="display:none"<?php } ?>>
                ...
                <td>
                    <?php echo $d['catid'];?>            </td>
                <td>
                    <span style="float:left"><?php echo $d['catname'];?></span>
                ...
                <td>
                    <?php echo helper::yes($d['isnav'],false);?>            </td>
