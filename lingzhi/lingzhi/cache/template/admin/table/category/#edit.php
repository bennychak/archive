...
<div id="position">
<a href="javascript:history.back(-1)" title="返回上一页"><img alt="返回上一页" src="<?php echo $skin_path;?>/undo.gif" style="float:right;" /></a>当前位置：编辑栏目
</div>

<div class="padding10">
<img src="<?php echo $skin_path;?>/wj.gif" style="margin-right:10px;" />欢迎来到编辑栏目页面。您可以编辑内容栏目，将网站内容加以栏目整理。
</div>
...
<?php echo form::getform('parentid',$form,$field,$data);?>  顶级栏目可跳过
</div>
</div>
...
<strong>栏目名称</strong>
<div class="hbox" style="background:none;">
<?php echo form::getform('catname',$form,$field,$data);?>  
</div>
</div>
...
<br /><br />
内容页URL规则：<br />
<?php echo form::getform('showhtmlrule',$form,$field,$data);?>
<br />
</div>
</div>
...
<?php echo form::input('thumb_width',$data['thumb_width'],'size="5"');?> px × <?php echo form::input('thumb_height',$data['thumb_height'],'size="5"');?> px
默认: <?php echo type::getwidthofthumb(get('id'));?> px × <?php echo type::getheightofthumb(get('id'));?> px
</div>
</div>
