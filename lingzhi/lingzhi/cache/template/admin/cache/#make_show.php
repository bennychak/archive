...
<div id="position">
<a href="javascript:history.back(-1)" title="返回上一页"><img alt="返回上一页" src="<?php echo $skin_path;?>/undo.gif" style="float:right;" /></a>当前位置：内容生成
</div>

<div class="padding10">
<img src="<?php echo $skin_path;?>/wj.gif" style="margin-right:10px;" />欢迎来到内容生成Html页面。您可以在生成内容的html静态页面，以便获得更好的SEO效果。
</div>
<div id="info">
<?php if(hasflash()) { ?>
