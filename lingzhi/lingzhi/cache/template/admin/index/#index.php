...
<div id="position">
<a href="javascript:history.back(-1)" title="返回上一页"><img alt="返回上一页" src="<?php echo $skin_path;?>/undo.gif" style="float:right;" /></a>当前位置：网站管理首页
</div>

<div class="padding5">
<img src="<?php echo $skin_path;?>/wj.gif" style="margin-right:10px;" />欢迎来到管理区。您可以在这里控制您站点的所有功能。
</div>
...
<?php $i=0;?>
<?php foreach($menu as $ns => $ms) { ?><?php $k=$i+1;?>
<div class="box">
<h3><?php echo $ns;?></h3>

<ul>
<?php foreach($ms as $n => $m) { ?>
<li><?php if($m) { ?><a href="<?php echo $m;?>"><?php echo $n;?></a><?php } else { ?><?php echo $n;?><?php } ?></li>
<?php } ?>
</ul>
<div class="blank10"></div>
</div>
<?php if($k%2==0) { ?><div class="clear"></div><?php } ?>
<?php $i++; ?>
