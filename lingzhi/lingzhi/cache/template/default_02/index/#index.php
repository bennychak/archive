...
<a href="<?php echo $t['url'];?>">网站新闻</a></h3><span>news</span></div></div>
...
<li><span class="date"><?php echo $archive['adddate'];?></span><a href="<?php echo $archive['url'];?>" title="<?php echo $archive['title'];?>"><span><?php echo $archive['title'];?></span></a></li>
<!-- <?php } ?> -->
</ul>
</div>
<div class="clear"></div>
...
<a href="<?php echo $archive['url'];?>" title="<?php echo $archive['title'];?>"><img src="<?php echo $archive['thumb'];?>" alt="<?php echo $archive['title'];?>" onerror='this.src="<?php echo config::get('onerror_pic');?>"' class="advice_pic" /></a>
...
<li><a href="<?php echo $archive['url'];?>" title="<?php echo $archive['title'];?>"><img src="<?php echo $archive['thumb'];?>" alt="<?php echo $archive['title'];?>" onerror='this.src="<?php echo config::get('onerror_pic');?>"' /></a></li>
