...
document.writeln("<style> ");
document.writeln(" .celive_box_content {  display: none;  position:fixed;  top: 25%;  left: 35%;  width: 439px;  height: 65px;padding:140px 15px 0px;  font-size:12px;background:url(<?php echo $config['url']?>\/js\/images\/k2.png) no-repeat left top; overflow: hidden;  font-size:13px; font-weight:bold ;color:white }");
document.writeln(" .celive_box_content  .diva{ display:block;width:56px;height:19px;line-height:19px;margin-top:25px;color:white;background:url(<?php echo $config['url']?>\/js\/images\/btn.gif);text-align:center; float:right; margin-left:10px;}");
...
document.writeln(" <span style=\"float:left;\">欢迎您!来自<?php echo $ip;?>的朋友,<?php echo $kefu_if_online;?>.<br \/>请问有什么可以帮助您的吗?<\/span>");
