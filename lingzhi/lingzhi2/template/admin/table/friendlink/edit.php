...
<div id="position">
<a href="javascript:history.back(-1)" title="返回上一页"><img alt="返回上一页" src="{$skin_path}/undo.gif" style="float:right;" /></a>当前位置：编辑友情链接
</div>

<div class="padding10">
<img src="{$skin_path}/wj.gif" style="margin-right:10px;" />欢迎来到编辑友情链接页面。您可以编辑与您合作的站点链接，以便获得良好的外链支持，从而使网站得到良好的推广效果。
</div>
