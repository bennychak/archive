...
<div id="position">
<a href="javascript:history.back(-1)" title="返回上一页"><img alt="返回上一页" src="{$skin_path}/undo.gif" style="float:right;" /></a>当前位置：编辑用户组
</div>


<div class="padding10">
<img src="{$skin_path}/wj.gif" style="margin-right:10px;" />欢迎来到编辑用户组页面。您可以编辑可登录网站用户的组别，以便更好的管理，使得网站与浏览者可以完成良好的互动形式。
</div>
