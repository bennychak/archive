...
<div id="position">
<a href="javascript:history.back(-1)" title="返回上一页"><img alt="返回上一页" src="{$skin_path}/undo.gif" style="float:right;" /></a>当前位置：添加分类
</div>

<div class="padding10">
<img src="{$skin_path}/wj.gif" style="margin-right:10px;" />欢迎来到添加分类页面。您可以添加内容分类，将网站内容加以分类整理。
</div>
...
{form::getform('parentid',$form,$field,$data)}  顶级分类可跳过
</div>
</div>
