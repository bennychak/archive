...
<table border="0" cellspacing="1" cellpadding="4" bgcolor="#CCCCCC">
  <tr bgcolor="#FFFFDD">
    <td colspan="2" class="diary_title">≤•∑≈¡–±Ì <a href="moremusic.asp">more</a></td>
  </tr>
  <% 
...
%>
    <tr bgcolor="#FFFFFF">
      ...
      <td><A HREF="delmusic.asp?<%= Server.HTMLEncode(MM_keepNone) & MM_joinChar(MM_keepNone) & "id=" & music.Fields.Item("id").Value %>">…æ≥˝</A></td>
    </tr>
    <% 
...
%>
  ...
  <tr bgcolor="#FFFFDD">
    <td colspan="2" class="diary_title">ÃÌº”“Ù¿÷</td>
  </tr><form id="music" name="music" method="POST" action="<%=MM_editAction%>">
  <tr bgcolor="#FFFFFF"><td colspan="2">“Ù¿÷√˚≥∆ <input name="name" type="text" size="40" maxlength="50" /></td>
    </tr>
  <tr bgcolor="#FFFFFF">
    <td colspan="2">“Ù¿÷µÿ÷∑ <input name="music" type="text" size="40" /></td>
  </tr>
  <tr bgcolor="#FFFFFF">
    <td></td>
    <td>
...
document.music.submit(); 
	...
	<input type="button" name="btnSubmit" onClick="doSubmit()" value="ÃÌº”" /></td>
  </tr>
