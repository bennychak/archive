...
Repeat1__numRows = 30
Repeat1__index = 0
guaiguai_article_numRows = guaiguai_article_numRows + Repeat1__numRows
%>
<%
...
<table width="620" border="0" cellspacing="0" cellpadding="0">
  ...
  <% 
While ((Repeat1__numRows <> 0) AND (NOT guaiguai_article.EOF)) 
%>
    <tr>
      ...
      <td><A HREF="articledel.asp?<%= Server.HTMLEncode(MM_keepNone) & MM_joinChar(MM_keepNone) & "id=" & guaiguai_article.Fields.Item("id").Value %>">删除</A></td>
    </tr>
    <% 
...
%>
  ...
  <tr>
    ...
    <td><a href="index.asp" target="_top">返回</a></td>
  </tr><tr>
      <td>&nbsp;</td>
